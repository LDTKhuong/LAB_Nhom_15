...
set xo_kernel_name "nco"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/HOC/HW_SW/BAI4/4C/hls_nco/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/HOC/HW_SW/BAI4/4C/hls_nco/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {nco_sine_lut_ROM_AUTO_1R
nco_control_s_axi
nco
}
set kernel_xo ""
set detect_deadlock_json "nco_message_dict.json"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 sine_sample R 0x0 "Data signal of sine_sample" {{0 16 sine_sample R 0 "Bit 15 to 0 of sine_sample"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x14 sine_sample_ctrl R 0x0 "Control signal of sine_sample" {{0 1 sine_sample_ap_vld R 0 "Control signal sine_sample_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 step_size W 0x0 "Data signal of step_size" {{0 16 step_size W 0 "Bit 15 to 0 of step_size"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
